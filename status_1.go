...
func processCSV(inputFilePath, outputFilePath string) error {
	...
	writer.Write([]string{"Repo Name", "Pull Request Link", "Status"})
	...
	for i, row := range records {
		...
		// Write the result to the output CSV with repo name, pull request link, and status
		writer.Write([]string{repoName, pullRequestLink, prStatus})
	}
